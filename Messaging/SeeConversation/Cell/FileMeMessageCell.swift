...
class FileMeMessageCell: BaseMessageCell {
...
//        let rightC3 = NSLayoutConstraint(item: timeContent, attribute: .trailing, relatedBy: .lessThanOrEqual, toItem: container, attribute: .trailing, multiplier: 1, constant: 12 * -1)
        let botC2 = NSLayoutConstraint(item: textContent, attribute: .bottom, relatedBy: .equal, toItem: container, attribute: .bottom, multiplier: 1, constant: 8 * -1)
        
        let topC4 = NSLayoutConstraint(item: downloadStatusImage, attribute: .top, relatedBy: .equal,
                                       toItem: container, attribute: .top, multiplier: 1, constant: 6)
        ...
        container.addConstraints([topC2, leftC2, topC4, rightC4, rightC2, botC2])
    }
}
